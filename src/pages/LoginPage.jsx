...
//   const initialValues = { identifier: "", password: "", rememberMe: false };
...
export default function LoginPage() {
  ...
  const loginSubmit = async (values) => {
    try {
      ...
      // هنا نستخدم setUser مع rememberMe
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={loginSubmit}>
          <Form className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span onClick={() => navigate("/forgot-password")} className="text-[rgba(217,23,108,1)] cursor-pointer">
                Forgot password?
              </span>
            </div>

            <button type="submit" className="text-white rounded-2xl bg-[rgba(217,23,108,1)] w-full py-2">
              Login
            </button>
