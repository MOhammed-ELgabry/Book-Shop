...
//     if (!sellerId && o.orderStatus === "pending") return true;
...
//   /* ---------------- REVENUE FIX ---------------- */
//   const sellerRevenue = baseOrders
//     .filter((o) => o.orderStatus !== "rejected")
//     .reduce((sum, order) => sum + (order.total || 0), 0);

//   const filteredOrders =
//     activeTab === "all"
//       ? baseOrders.filter((o) => o.orderStatus !== "delivered")
//       : baseOrders.filter(
//           (o) =>
...
//               <div key={order.documentId} className="bg-white p-6 rounded-2xl shadow border">
...
//                     <button
//                       onClick={() => handleStatusChange(order.documentId, "accepted")}
...
//                     <button
//                       onClick={() => handleStatusChange(order.documentId, "delivered")}
