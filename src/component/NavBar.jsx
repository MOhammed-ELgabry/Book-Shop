...
//         <NavLink to="/" className={({ isActive }) => `text-2xl hidden md:inline-block px-2   ${isActive ? "text-orange-500" : "text-white"}`}>Home</NavLink>
//         <NavLink to="/books" className={({ isActive }) => `text-2xl hidden md:inline-block px-2 ${isActive ? "text-orange-500" : "text-white"}`}>Books</NavLink>
//         <NavLink to="/about" className={({ isActive }) => `text-2xl hidden md:inline-block px-2 ${isActive ? "text-orange-500" : "text-white"}`}>About Us</NavLink>
//       </div>
...
//           <>
//             {/* User Info */}
//             <div onClick={() => navigate("/profile")} className="flex flex-col items-center text-white text-sm cursor-pointer">
...
//             {/* 🚪 Logout */}
//             <button onClick={handleLogout} className="bg-red-500 px-4 py-2 rounded text-white hover:bg-red-600 transition">Logout</button>
//           </>
//         ) : (
//           <>
//             <button onClick={() => navigate("/login")} className="bg-[rgba(217,23,108,1)] px-4 py-2 rounded text-white">Log in</button>
//             <button onClick={() => navigate("/register")} className="bg-white px-4 py-2 rounded text-[rgba(217,23,108,1)]">Sign Up</button>
//           </>
//         )}
//       </div>
